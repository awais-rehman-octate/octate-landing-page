...
export const insightData = [
  {
    ...
    description: "Budgeting, cashflow, and forecasting made easy.",
  },
  {
    icon: SparklesIcon,
    title: "Streamlined Accounting",
    description:
      "Seamlessly integrated accounting to keep your finances in check.",
  },
  {
    icon: LockClosedIcon,
    title: "Order Efficiency",
    description: "Manage orders with precision and speed.",
  },
  {
    icon: HeartIcon,
    title: "Data Insights",
    description: "Business intelligence for smarter decisions.",
  },
];
